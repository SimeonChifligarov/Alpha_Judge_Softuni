...
easter_bread_price = price_1kg_flour + price_1pack_eggs + price_1l_milk / 4
...
while budget > 0:
    ...
    colored_eggs += 3
    if easter_bread_count % 3 == 0 and budget >= 0:
...
print(
    f'You made {easter_bread_count} loaves of Easter bread! Now you have {colored_eggs} eggs and {budget:.2f}BGN left.')
