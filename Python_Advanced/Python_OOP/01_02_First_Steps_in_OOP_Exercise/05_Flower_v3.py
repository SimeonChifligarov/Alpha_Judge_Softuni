class Flower:
    ...
    def status(self) -> str:
        ...
        # return f"{self.name} is{ {True: '', False: ' not'}[self.is_happy]} happy"
    ...
    def __repr__(self) -> str:
        return f'Flower(name={self.name!r}, water_requirements={self.water_requirements!r}, is_happy={self.is_happy!r})'
...
#     print(flower_instance.status())
#     print(str(flower_instance))
#     print(repr(flower_instance))
#     print(bool(flower_instance))
