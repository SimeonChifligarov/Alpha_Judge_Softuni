class Programmer:
    ...
    def __str__(self) -> str:
        return f'{self.name} codes in {self.language} and has {self.skills} skills.'

    # def __repr__(self) -> str:
    #     return f'Programmer(name={self.name!r}, language={self.language!r}, skills={self.skills!r})'
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, Programmer):
            return (self.name, self.language, self.skills) == (other.name, other.language, other.skills)
        return NotImplemented
...
#     print(str(dev_instance))
#     print(repr(dev_instance))
