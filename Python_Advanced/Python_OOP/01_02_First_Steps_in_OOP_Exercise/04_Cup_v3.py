class Cup:
    ...
    def __str__(self) -> str:
        return f'Cup has {self.quantity} of {self.size} filled.'

    def __repr__(self) -> str:
        return f'Cup(size={self.size!r}, quantity={self.quantity!r})'
...
#     print(cup_instance.status())
#     print(str(cup_instance))
#     print(repr(cup_instance))
#     print(bool(cup_instance))
