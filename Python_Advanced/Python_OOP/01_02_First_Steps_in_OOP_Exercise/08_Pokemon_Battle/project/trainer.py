# project = '08_pokemon_battle'
# from project.pokemon import Pokemon  # TODO uncomment this one when submitting in Judge
from pokemon import Pokemon  # TODO comment-out this one when submitting in Judge
