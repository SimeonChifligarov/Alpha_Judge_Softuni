class SteamUser:
    ...
    def __repr__(self) -> str:
        return f'SteamUser(username={self.username!r}, games={self.games!r}, played_hours={self.played_hours!r})'
...
#     print(str(steam_instance))
#     print(repr(steam_instance))
#     print(len(steam_instance))
#     print(bool(steam_instance))
