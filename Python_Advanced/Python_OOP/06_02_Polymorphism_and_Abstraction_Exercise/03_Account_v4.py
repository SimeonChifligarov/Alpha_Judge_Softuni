...
class Account:
    ...
    def __next__(self) -> int:
        raise NotImplementedError('Use iterator directly over transactions.')
    ...
    def __contains__(self, transaction: Any) -> bool:
        """
        Check if a transaction is in the account.

        Args:
            transaction (Any): The transaction to check.
    ...
    def __bool__(self) -> bool:
        ...
        Returns:
            bool: True if balance is greater than zero, otherwise False.
        """
