...
class Car(Vehicle):
    ...
    def __repr__(self) -> str:
        return f'Car(fuel_quantity={self.fuel_quantity}, fuel_consumption={self.fuel_consumption})'

    def __str__(self) -> str:
        return f'Car with {self.fuel_quantity} liters of fuel'

    def __hash__(self) -> int:
        return hash((self.fuel_quantity, self.fuel_consumption))
...
class Truck(Vehicle):
    ...
    def __repr__(self) -> str:
        return f'Truck(fuel_quantity={self.fuel_quantity}, fuel_consumption={self.fuel_consumption})'

    def __str__(self) -> str:
        return f'Truck with {self.fuel_quantity} liters of fuel'
