def extract_even_matrix(row_total: int, matrix_values: list[list[int]]) -> list[list[int]]:
    """
...
if __name__ == '__main__':
    ...
    filtered_matrix = extract_even_matrix(row_total=row_count, matrix_values=original_matrix)
