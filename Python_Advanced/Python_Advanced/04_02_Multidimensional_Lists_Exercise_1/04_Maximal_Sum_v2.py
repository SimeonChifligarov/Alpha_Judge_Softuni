def find_max_3x3_square(row_count: int, column_count: int, matrix_data: list[list[int]]) -> tuple[int, list[list[int]]]:
    """
...
if __name__ == '__main__':
    ...
    total_rows = int(dimensions_input[0])
    total_columns = int(dimensions_input[1])
    ...
    max_total, max_square = find_max_3x3_square(
